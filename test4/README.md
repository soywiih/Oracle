...
## **创建用户study**
```
CREATE USER STUDY18 IDENTIFIED BY 123
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/1.png)        
## -- QUOTAS
```
ALTER USER STUDY18 QUOTA UNLIMITED ON USERS;
ALTER USER STUDY18 QUOTA UNLIMITED ON USERS02;
ALTER USER STUDY18 ACCOUNT UNLOCK;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/2.png)   
## -- ROLES
```
GRANT "CONNECT" TO STUDY18 WITH ADMIN OPTION;
GRANT "RESOURCE" TO STUDY18 WITH ADMIN OPTION;
ALTER USER STUDY18 DEFAULT ROLE "CONNECT","RESOURCE";
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/3.png)      
## -- SYSTEM PRIVILEGES
```
GRANT CREATE VIEW TO STUDY18 WITH ADMIN OPTION;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/4.png)     
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/5.png)     
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/6.png)   
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/7.png)     
```
...
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/8.png)    
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/9.png)     
```
...
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/10.png)     
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/11.png)   
```
CREATE TABLE ORDERS
(
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/12.png)    
## **创建本地分区索引ORDERS_INDEX_DATE18**
```
...
NOPARALLEL;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/13.png)     
```
CREATE INDEX ORDERS_INDEX_CUSTOMER_NAME18 ON ORDERS (CUSTOMER_NAME ASC)
NOLOGGING
TABLESPACE USERS
PCTFREE 10
INITRANS 2
...
NOPARALLEL;CREATE INDEX ORDERS_INDEX_CUSTOMER_NAME18 ON ORDERS (CUSTOMER_NAME ASC)
NOLOGGING
TABLESPACE USERS
PCTFREE 10
INITRANS 2
...
NOPARALLEL;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/14.png)    
```
CREATE UNIQUE INDEX ORDERS_PK18 ON ORDERS (ORDER_ID ASC)
...
NOPARALLEL;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/15.png)   
```
ALTER TABLE ORDERS
ADD CONSTRAINT ORDERS_PK18 PRIMARY KEY
(
  ORDER_ID
)
USING INDEX ORDERS_PK18
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/16.png)     
```
ALTER TABLE ORDERS
...
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/17.png)    
```
...
;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/18.png)     
```
CREATE UNIQUE INDEX ORDER_DETAILS_PK18 ON ORDER_DETAILS (ID ASC)
NOLOGGING
TABLESPACE USERS
PCTFREE 10
INITRANS 2
...
ADD CONSTRAINT ORDER_DETAILS_PK18 PRIMARY KEY
(
  ID
)
USING INDEX ORDER_DETAILS_PK18
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/19.png)    
...
ENABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/20.png)     
## **创建三个触发器**
```
CREATE OR REPLACE EDITIONABLE TRIGGER "ORDERS_TRIG_ROW_LEVEL18"
...
END;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/21.png)    
## **批量插入订单数据之前，禁用触发器**
```
ALTER TRIGGER "ORDERS_TRIG_ROW_LEVEL" DISABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/22.png)   
```
...
END;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/23.png)   
```
...
END;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/24.png)   
```
ALTER TRIGGER "ORDER_DETAILS_SNTNS_TRIG" DISABLE;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/25.png)   
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/26.png)    
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/27.png)    
```
declare
  dt date;
  m number(8,2);
...
NOCOMPRESS;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/28.png)     
## **开始测试**
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/29.png)    
...
SELECT * FROM A;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/30.png)      
## **特殊查询语句：**
### 查询分区表情况:
```
select TABLE_NAME,PARTITION_NAME,HIGH_VALUE,PARTITION_POSITION,TABLESPACE_NAME from user_tab_partitions
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/31.jpg)        
### 查询分区索引情况：
```
select * from USER_IND_PARTITIONS;
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/32.png)      
### 查询一个分区中的数据
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/33.png)  
### 分析单个表
```
exec dbms_stats.gather_table_stats(user,'ORDERS',cascade=>true);
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/34.png)      
```
exec dbms_stats.gather_table_stats(user,'ORDER_DETAILS',cascade=>true);
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/35.png)   
## **统计用户的所有表**
```
exec dbms_stats.gather_schema_stats(User,estimate_percent=>100,cascade=> TRUE);
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/36.png)    
## **统计完成后，查询表的统计信息：**
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/37.png)     
## **查看表空间的使用情况**
```
...
```
![ABC](https://github.com/soywiih/oracle/blob/master/test4/38.png)     
## **查看数据文件大小:**
```
ls -lh /home/oracle/app/oracle/oradata/orcl/pdbtest/pdbtest_users*
```
